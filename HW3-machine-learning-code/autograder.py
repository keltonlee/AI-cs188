...
def check_perceptron(tracker):
    ...
    tracker.add_points(15) # Partial credit for passing sanity checks
...
def check_regression(tracker):
    ...
    tracker.add_points(20) # Partial credit for passing sanity checks
